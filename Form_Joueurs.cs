...
namespace TPFinal
{
    public partial class Form_Joueurs : Form
    {
        ...
        {
            Form_Ajouter_Joueur aJ = new Form_Ajouter_Joueur();
            ...
            if (!currval)
                commandeSQL = "SELECT MAX(numerojoueur) from joueur ";
            else
        ...
        {
            UnbindTB();
            TB_NumJoueur.DataBindings.Add("Text", dataSetJoueur, "Joueur.NumeroJoueurs");
            TB_NomJoueur.DataBindings.Add("Text", dataSetJoueur, "Joueur.NomJoueurs");
            ...
            CB_EquipeJoueur.DataBindings.Add("SelectedItem", dataSetJoueur, "Joueur.EquipeJoueur");
        ...
        private void BTN_Effacer_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Voulez-vous vraiment effacer cette entrée ?", "Confirmation", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK) ;
            {
                try
                {
                    ...
                    string sql = "Delete from joueurs Where numerojoueurs =:numjoueur";
        ...
        private void BTN_Modifier_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "Update joueurs set Nomjoueurs =:Nomjoueurs, Prenomjoueur =:Prenomjoueur, datenaissance =:datenaissance, numeromaillot =:numeromaillot, equipejoueur =:equipejoueur , positionjoueur=:positionjoueur" +
                             "where numerojoueurs =:numerojoueurs";
                try
                {
